...
from PECA_Net.experiment_planning.summarize_plans import summarize_plans
...
def get_default_configuration(network, task, network_trainer, plans_identifier=default_plans_identifier,
                              search_in=(PECA_Net.__path__[0], "training", "network_training"),
                              base_module='PECA_Net.training.network_training'):
    ...
    if task=='Task001_ACDC':
        ...
        plans['plans_per_stage'][Stage]['patch_size']=np.array([16,160,160])  # UNETR++ patch_size = [16,160,160]  PECA_Net = [14, 160, 160]
    ...
    print("###############################################")
    print("I am running the following PECA_Net: %s" % network)
