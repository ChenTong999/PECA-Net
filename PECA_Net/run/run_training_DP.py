...
def main():
    ...
    if network == "3d_cascade_fullres":
        assert issubclass(trainer_class, PECA_NetTrainerCascadeFullRes), "If running 3d_cascade_fullres then your " \
                                                                       "trainer class must be derived from " \
                                                                       "PECA_NetTrainerCascadeFullRes"
    else:
        assert issubclass(trainer_class, PECA_NetTrainer), "network_trainer was found but is not derived from " \
                                                         "PECA_NetTrainer"
