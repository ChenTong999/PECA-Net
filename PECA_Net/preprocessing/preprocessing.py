...
from PECA_Net.configuration import default_num_threads, RESAMPLING_SEPARATE_Z_ANISO_THRESHOLD
from PECA_Net.preprocessing.cropping import get_case_identifier_from_npz, ImageCropper
...
class GenericPreprocessor(object):
    ...
    def run(self, target_spacings, input_folder_with_cropped_npz, output_folder, data_identifier,
        ...
        for i in range(num_stages):
            ...
            mkdir_func(output_folder_stage)
