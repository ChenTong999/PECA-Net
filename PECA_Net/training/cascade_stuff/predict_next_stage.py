...
import argparse
from PECA_Net.preprocessing.preprocessing import resample_data_or_seg
...
if __name__ == "__main__":
    ...
    trainer_class = recursive_find_python_class([join(PECA_Net.__path__[0], "training", "network_training")],
                                                trainerclass,
                                                "PECA_Net.training.network_training")
