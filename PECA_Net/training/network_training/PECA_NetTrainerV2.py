...
class PECA_NetTrainerV2(PECA_NetTrainer):
    """
    Info for Fabian: same as internal PECA_NetTrainerV2_2
    """
    ...
    def initialize_network(self):
        ...
        self.network = Generic_UNet(self.num_input_channels, self.base_num_features, self.num_classes,
                                    ...
                                    net_nonlin, net_nonlin_kwargs, True, False, self.tmp_func, InitWeights_He(1e-2),
    ...
    def on_epoch_end(self):
        ...
        # it can rarely happen that the momentum of PECA_NetTrainerV2 is too high for some dataset. If at epoch 100 the
