...
from PECA_Net.training.network_training.PECA_NetTrainerV2 import PECA_NetTrainerV2
...
class PECA_NetTrainerV2CascadeFullRes(PECA_NetTrainerV2):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, previous_trainer="PECA_NetTrainerV2", fp16=False):
