...
from PECA_Net.training.data_augmentation.custom_transforms import Convert3DTo2DTransform, Convert2DTo3DTransform, \
    MaskTransform, ConvertSegmentationToRegionsTransform
from PECA_Net.training.data_augmentation.pyramid_augmentations import MoveSegAsOneHotToData, \
...
default_3D_augmentation_params = {
    ...
    "num_threads": 12 if 'PECA_Net_n_proc_DA' not in os.environ else int(os.environ['PECA_Net_n_proc_DA']),
...
if __name__ == "__main__":
    from PECA_Net.training.dataloading.dataset_loading import DataLoader3D, load_dataset
