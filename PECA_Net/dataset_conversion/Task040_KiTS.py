...
def copy_npz_fom_valsets():
    ...
    folders = ['PECA_NetTrainerNewCandidate23_FabiansPreActResNet__PECA_NetPlans',
               'PECA_NetTrainerNewCandidate23_FabiansResNet__PECA_NetPlans',
               'PECA_NetTrainerNewCandidate23__PECA_NetPlans']
    for f in folders:
...
def ensemble(experiments=('PECA_NetTrainerNewCandidate23_FabiansPreActResNet__PECA_NetPlans',
               'PECA_NetTrainerNewCandidate23_FabiansResNet__PECA_NetPlans'), out_dir="/media/fabian/Results/PECA_Net/3d_lowres/Task048_KiTS_clean/ensemble_preactres_and_res"):
    from PECA_Net.inference.ensemble_predictions import merge
...
def prepare_submission(fld= "/home/fabian/drives/datasets/results/PECA_Net/test_sets/Task048_KiTS_clean/predicted_ens_3d_fullres_3d_cascade_fullres_postprocessed", # '/home/fabian/datasets_fabian/predicted_KiTS_PECA_NetTrainerNewCandidate23_FabiansResNet',
                       out='/home/fabian/drives/datasets/results/PECA_Net/test_sets/Task048_KiTS_clean/submission'):
...
def pretent_to_be_PECA_NetTrainer(base, folds=(0, 1, 2, 3, 4)):
    """
    changes best checkpoint pickle PECA_Nettrainer class name to PECA_NetTrainer
    :param experiments:
    :return:
    """
    for fold in folds:
...
def PECA_NetTrainer_these(experiments=('PECA_NetTrainerNewCandidate23_FabiansPreActResNet__PECA_NetPlans',
               'PECA_NetTrainerNewCandidate23_FabiansResNet__PECA_NetPlans',
               'PECA_NetTrainerNewCandidate23__PECA_NetPlans')):
    """
    changes best checkpoint pickle PECA_Nettrainer class name to PECA_NetTrainer
    ...
    for exp in experiments:
        cur = join(base, exp)
        pretent_to_be_PECA_NetTrainer(cur)


def reset_trainerName_these(experiments=('PECA_NetTrainerNewCandidate23_FabiansPreActResNet__PECA_NetPlans',
               'PECA_NetTrainerNewCandidate23_FabiansResNet__PECA_NetPlans',
               'PECA_NetTrainerNewCandidate23__PECA_NetPlans')):
    """
    changes best checkpoint pickle PECA_Nettrainer class name to PECA_NetTrainer
...
if __name__ == "__main__":
    ...
    out = "/media/fabian/My Book/MedicalDecathlon/PECA_Net_raw_splitted/Task040_KiTS"
