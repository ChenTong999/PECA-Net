...
def convert_for_submission(source_dir, target_dir):
    ...
    for f in files:
        ...
        t = join(target_dir, "test%02d_%02d_PECA_Net.nii" % (case_id, timestep))
...
if __name__ == "__main__":
    ...
    maybe_mkdir_p("/media/fabian/PECA_Net/Task035_ISBILesionSegmentation")
    save_pickle(splits, join("/media/fabian/PECA_Net/Task035_ISBILesionSegmentation", "splits_final.pkl"))
