...
from PECA_Net.dataset_conversion.Task056_VerSe2019 import check_if_all_in_good_orientation, \
    print_unique_labels_and_their_volumes
from PECA_Net.paths import PECA_Net_raw_data, preprocessing_output_dir
from PECA_Net.utilities.image_reorientation import reorient_all_images_in_folder_to_ras


def manually_change_plans():
    pp_out_folder = join(preprocessing_output_dir, "Task083_VerSe2020")
    original_plans = join(pp_out_folder, "PECA_NetPlansv2.1_plans_3D.pkl")
...
if __name__ == "__main__":
    ### First we create a PECA_Net dataset from verse. After this the images will be all willy nilly in their
    ...
    folder_gt = "/media/fabian/My Book/MedicalDecathlon/PECA_Net_raw_splitted/Task056_VerSe/labelsTr"

    folder_pred = "/home/fabian/drives/datasets/results/PECA_Net/3d_fullres/Task056_VerSe/PECA_NetTrainerV2__PECA_NetPlansv2.1/cv_niftis_raw"
    out_json = "/home/fabian/Task056_VerSe_3d_fullres_summary.json"
    evaluate_verse_folder(folder_pred, folder_gt, out_json)

    folder_pred = "/home/fabian/drives/datasets/results/PECA_Net/3d_lowres/Task056_VerSe/PECA_NetTrainerV2__PECA_NetPlansv2.1/cv_niftis_raw"
    out_json = "/home/fabian/Task056_VerSe_3d_lowres_summary.json"
    evaluate_verse_folder(folder_pred, folder_gt, out_json)

    folder_pred = "/home/fabian/drives/datasets/results/PECA_Net/3d_cascade_fullres/Task056_VerSe/PECA_NetTrainerV2CascadeFullRes__PECA_NetPlansv2.1/cv_niftis_raw"
