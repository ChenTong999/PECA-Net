...
if __name__ == "__main__":
    ...
    output_raw = join(PECA_Net_raw_data, full_taskname)
    shutil.rmtree(output_raw)
    shutil.copytree(join(PECA_Net_raw_data, 'Task999_Fluo-N2DH-SIM_thickborder'), output_raw)

    shutil.rmtree(join(PECA_Net_raw_data, 'Task999_Fluo-N2DH-SIM_thickborder'))
