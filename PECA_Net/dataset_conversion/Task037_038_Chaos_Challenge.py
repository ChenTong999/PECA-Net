...
from PECA_Net.paths import preprocessing_output_dir, PECA_Net_raw_data
from PECA_Net.utilities.sitk_stuff import copy_geometry
...
def convert_variant2_predicted_test_to_submission_format(folder_with_predictions,
                                                         output_folder="/home/fabian/drives/datasets/results/PECA_Net/test_sets/Task038_CHAOS_Task_3_5_Variant2/ready_to_submit",
                                                         postprocessing_file="/home/fabian/drives/datasets/results/PECA_Net/ensembles/Task038_CHAOS_Task_3_5_Variant2/ensemble_2d__PECA_NetTrainerV2__PECA_NetPlansv2.1--3d_fullres__PECA_NetTrainerV2__PECA_NetPlansv2.1/postprocessing.json"):
    """
    ...
    :return:
    """
    postprocessing_file = "/media/fabian/Results/PECA_Net/3d_fullres/Task039_CHAOS_Task_3_5_Variant2_highres/" \
                          "PECA_NetTrainerV2__PECA_NetPlansfixed/postprocessing.json"
    ...
    from PECA_Net.postprocessing.connected_components import apply_postprocessing_to_folder, load_postprocessing
