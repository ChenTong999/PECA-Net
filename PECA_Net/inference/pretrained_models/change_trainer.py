...
def pretend_to_be_PECA_NetTrainer(folder, checkpoints=("model_best.model.pkl", "model_final_checkpoint.model.pkl")):
    pretend_to_be_other_trainer(folder, "PECA_NetTrainer", checkpoints)
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description='Use this script to change the PECA_Net trainer class of a saved '
