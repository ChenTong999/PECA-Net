...
from PECA_Net.network_architecture.tumor.model_components import UnetrPPEncoder, UnetrUpBlock
...
class PECA_Net(SegmentationNetwork):
    ...
    def __init__(
        ...
        if self.do_ds:
            ...
            self.out2 = nn.ConvTranspose3d(feature_size * 2, out_channels, (2, 2, 2), (2, 2, 2))
            self.out3 = nn.ConvTranspose3d(feature_size * 4, out_channels, (2, 2, 2), (2, 2, 2))
