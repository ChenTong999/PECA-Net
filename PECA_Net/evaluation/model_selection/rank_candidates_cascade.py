...
if __name__ == "__main__":
    ...
    plans = "PECA_NetPlansv2.1"

    overwrite_plans = {
        'PECA_NetTrainerCascadeFullRes': ['PECA_NetPlans'],
    }

    trainers = [
        'PECA_NetTrainerCascadeFullRes',
        'PECA_NetTrainerV2CascadeFullRes_EducatedGuess',
        'PECA_NetTrainerV2CascadeFullRes_EducatedGuess2',
        'PECA_NetTrainerV2CascadeFullRes_EducatedGuess3',
        'PECA_NetTrainerV2CascadeFullRes_lowerLR',
        'PECA_NetTrainerV2CascadeFullRes',
        'PECA_NetTrainerV2CascadeFullRes_noConnComp',
        'PECA_NetTrainerV2CascadeFullRes_shorter_lowerLR',
        'PECA_NetTrainerV2CascadeFullRes_shorter',
        'PECA_NetTrainerV2CascadeFullRes_smallerBinStrel',
        #'',
        #'',
        #'',
        #'',
