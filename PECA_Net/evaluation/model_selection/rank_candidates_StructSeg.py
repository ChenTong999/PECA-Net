...
if __name__ == "__main__":
    ...
    overwrite_plans = {
        'PECA_NetTrainerV2_2': ["PECA_NetPlans", "PECA_NetPlans_customClip"], # r
        'PECA_NetTrainerV2_2_noMirror': ["PECA_NetPlans", "PECA_NetPlans_customClip"],  # r
        'PECA_NetTrainerV2_lessMomentum_noMirror': ["PECA_NetPlans", "PECA_NetPlans_customClip"],  # r
        'PECA_NetTrainerV2_2_structSeg_noMirror': ["PECA_NetPlans", "PECA_NetPlans_customClip"],  # r
        'PECA_NetTrainerV2_2_structSeg': ["PECA_NetPlans", "PECA_NetPlans_customClip"],  # r
        'PECA_NetTrainerV2_lessMomentum_noMirror_structSeg': ["PECA_NetPlans", "PECA_NetPlans_customClip"],  # r
        'PECA_NetTrainerV2_FabiansResUNet_structSet_NoMirror_leakyDecoder': ["PECA_NetPlans", "PECA_NetPlans_customClip"],  # r
        'PECA_NetTrainerV2_FabiansResUNet_structSet_NoMirror': ["PECA_NetPlans", "PECA_NetPlans_customClip"],  # r
        'PECA_NetTrainerV2_FabiansResUNet_structSet': ["PECA_NetPlans", "PECA_NetPlans_customClip"],  # r

    }

    trainers = ['PECA_NetTrainer'] + [
        'PECA_NetTrainerV2_2',
        'PECA_NetTrainerV2_lessMomentum_noMirror',
        'PECA_NetTrainerV2_2_noMirror',
        'PECA_NetTrainerV2_2_structSeg_noMirror',
        'PECA_NetTrainerV2_2_structSeg',
        'PECA_NetTrainerV2_lessMomentum_noMirror_structSeg',
        'PECA_NetTrainerV2_FabiansResUNet_structSet_NoMirror_leakyDecoder',
        'PECA_NetTrainerV2_FabiansResUNet_structSet_NoMirror',
        'PECA_NetTrainerV2_FabiansResUNet_structSet',
    ]
