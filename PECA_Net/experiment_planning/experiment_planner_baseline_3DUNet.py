...
from PECA_Net.experiment_planning.common_utils import get_pool_and_conv_props_poolLateV2
from PECA_Net.experiment_planning.utils import create_lists_from_splitted_dataset
from PECA_Net.network_architecture.generic_UNet import Generic_UNet
from PECA_Net.paths import *
from PECA_Net.preprocessing.cropping import get_case_identifier_from_npz
...
class ExperimentPlanner(object):
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        ...
        self.preprocessed_output_folder = preprocessed_output_folder.replace('\\', '/')
        ...
        self.plans_fname = join(self.preprocessed_output_folder, "PECA_NetPlans" + "fixed_plans_3D.pkl")
    ...
    def save_my_plans(self):
        plans_fname = self.plans_fname.replace('\\', '/')
    ...
    def run_preprocessing(self, num_threads):
        ...
        preprocessor_class = recursive_find_python_class([join(PECA_Net.__path__[0], "preprocessing")],
                                                         self.preprocessor_name, current_module="PECA_Net.preprocessing")
...
if __name__ == "__main__":
    ...
    for i in task_ids:
        i = int(i)
        candidates = subdirs(PECA_Net_cropped_data, prefix="Task%03.0d" % i, join=False)
