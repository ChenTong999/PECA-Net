...
from PECA_Net.experiment_planning.utils import add_classes_in_slice_info
from PECA_Net.network_architecture.generic_UNet import Generic_UNet
from PECA_Net.paths import *
from PECA_Net.preprocessing.preprocessing import PreprocessorFor2D
...
class ExperimentPlanner2D(ExperimentPlanner):
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        ...
        self.plans_fname = join(self.preprocessed_output_folder, "PECA_NetPlans" + "_plans_2D.pkl")
