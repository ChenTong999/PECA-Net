...
from PECA_Net.experiment_planning.utils import split_4d
from PECA_Net.utilities.file_endings import remove_trailing_slash
...
def main():
    ...
    print(args.i, ",", args.p, ",", args.output_task_id)
