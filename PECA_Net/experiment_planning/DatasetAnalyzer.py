...
from PECA_Net.paths import PECA_Net_raw_data, PECA_Net_cropped_data
import numpy as np
import pickle
from PECA_Net.preprocessing.cropping import get_patient_identifiers_from_cropped_files
...
class DatasetAnalyzer(object):
    def __init__(self, folder_with_cropped_data, overwrite=True, num_processes=default_num_threads):
        ...
        self.folder_with_cropped_data = folder_with_cropped_data.replace('\\', '/')
